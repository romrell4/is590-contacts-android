...
class MainActivity: AppCompatActivity() {
    ...
    private var contacts: List<Contact> = listOf(
            Contact("Android Anderson", R.drawable.android, "BYU OIT", "Test User", "oit.android@gmail.com", null, "Siri", "1388 N University Avenue, Provo UT 84602", "I am a test user. I enjoy testing android apps. Please feel free to edit me if you would like!"),
            Contact("Doctor Liddle", R.drawable.doctor_liddle, "BYU", "Professor", "drliddle@gmail.com", null, "Stuart", "101 Mobile Street, Provo UT", "This is my professor. He's pretty cool. He teaches lots of mobile and desktop application classes to BYU students. If you are logged in as him, feel free to edit this text!"),
